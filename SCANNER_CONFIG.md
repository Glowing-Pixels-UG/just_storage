...
SCANNER_STORAGE_API_KEY=***REMOVED-API-KEY***
...
```bash
Authorization: ApiKey ***REMOVED-API-KEY***
```
...
curl -X POST "https://storage.bk.glpx.pro/v1/objects?namespace=canon-scanner-documents&tenant_id=2f161fa2-06f6-46a4-88dc-3894b94ec6ee&key=document-001" \
  -H "Authorization: ApiKey ***REMOVED-API-KEY***" \
...
```bash
curl -H "Authorization: ApiKey ***REMOVED-API-KEY***" \
